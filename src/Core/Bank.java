...
public class Bank implements Runnable {
    ...
    HashMap<Client,Bank> clientBankHashMap=new HashMap<>();

    public Bank(){
      try {
       bank=new ServerSocket(port);
          System.out.println("سرور ایجاد شد.");
       while (true){
           Socket client =bank.accept();
           Thread thread=new Thread(new BankManager(this,client));
